...
const PRICING_PACKAGES = [
  { id: 'auto_apply', label: 'Auto-Apply Plan', amountINR: 499, credits: 2000, description: '2,000 application credits/month. Auto-apply to jobs on LinkedIn.', type: 'subscription' },
