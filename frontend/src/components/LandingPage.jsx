      ...
      <main id="main"><span id="top"></span>
        ...
        <section className="pricing" id="pricing">
          <div className="wrap">
            ...
            <div className="pgrid">
              <div className="plan reveal"><h3>Auto-Apply Plan</h3><p className="desc">Just the auto-apply power.</p><div className="price">₹499<small>/one-time</small></div><ul><li><svg className="icon"><use href="#i-check" /></svg> 2,000 apply credits</li><li><svg className="icon"><use href="#i-check" /></svg> AI-tailored résumé per job</li><li><svg className="icon"><use href="#i-check" /></svg> Auto-apply on LinkedIn</li><li><svg className="icon"><use href="#i-check" /></svg> ATS match scoring</li><li><svg className="icon"><use href="#i-check" /></svg> Dashboard tracking</li></ul><a className="btn btn-ghost btn-block" href="#" data-cursor="Choose" onClick={handlePricing}>Get started</a></div>
