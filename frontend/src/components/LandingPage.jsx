      ...
      <main id="main"><span id="top"></span>
        ...
        <section className="pricing" id="pricing">
          <div className="wrap">
            ...
            <div className="pgrid">
              <div className="plan reveal"><h3>Base Plan</h3><p className="desc">For the focused, part-time search.</p><div className="price">₹999<small>/mo</small></div><ul><li><svg className="icon"><use href="#i-check" /></svg> 5 credits / month</li><li><svg className="icon"><use href="#i-check" /></svg> Auto Apply + AI résumés</li><li><svg className="icon"><use href="#i-check" /></svg> Voice mock interviews</li><li><svg className="icon"><use href="#i-check" /></svg> ATS match scoring</li><li><svg className="icon"><use href="#i-check" /></svg> Top-ups available</li></ul><a className="btn btn-ghost btn-block" href="#" data-cursor="Choose" onClick={handlePricing}>Get started</a></div>
              <div className="plan reveal"><h3>Credit Top-up</h3><p className="desc">Extra sessions on demand.</p><div className="price">₹249<small>/credit</small></div><ul><li><svg className="icon"><use href="#i-check" /></svg> 1 credit</li><li><svg className="icon"><use href="#i-check" /></svg> Use for applies or mocks</li><li><svg className="icon"><use href="#i-check" /></svg> Requires active Base Plan</li><li><svg className="icon"><use href="#i-check" /></svg> Instant activation</li></ul><a className="btn btn-ghost btn-block" href="#" data-cursor="Add" onClick={handlePricing}>Add credits</a></div>
              <div className="plan feat reveal"><span className="tag">Most popular</span><h3>Monthly Unlimited</h3><p className="desc">For active interview season.</p><div className="price">₹3,999<small>/mo</small></div><ul><li><svg className="icon"><use href="#i-check" /></svg> Unlimited auto-applies</li><li><svg className="icon"><use href="#i-check" /></svg> Unlimited voice mocks</li><li><svg className="icon"><use href="#i-check" /></svg> Priority AI tailoring</li><li><svg className="icon"><use href="#i-check" /></svg> Follow-up email generator</li><li><svg className="icon"><use href="#i-check" /></svg> Priority support</li></ul><a className="btn btn-primary btn-block" href="#" data-magnetic data-cursor="Choose" onClick={handlePricing}>Get started</a></div>
              <div className="plan reveal"><h3>Quarterly Unlimited</h3><p className="desc">Best value for long searches.</p><div className="price">₹9,999<small>/3 mo</small></div><ul><li><svg className="icon"><use href="#i-check" /></svg> Unlimited for 3 months</li><li><svg className="icon"><use href="#i-check" /></svg> Save 17%+ vs monthly</li><li><svg className="icon"><use href="#i-check" /></svg> Priority AI tailoring</li><li><svg className="icon"><use href="#i-check" /></svg> Follow-up email generator</li><li><svg className="icon"><use href="#i-check" /></svg> Priority support</li></ul><a className="btn btn-ghost btn-block" href="#" data-cursor="Choose" onClick={handlePricing}>Get started</a></div>
            </div>
